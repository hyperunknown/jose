...
trait EncrypterTrait
{
     ...
     */
    abstract protected function checkKeyUsage(JWKInterface $key, string $usage);
     ...
     * @return string
     */
    private function determineCEK(JWEInterface $jwe, ContentEncryptionAlgorithmInterface $content_encryption_algorithm, string $key_management_mode, array &$additional_headers): string
    {
     ...
     * @return string
     */
    private function getKeyManagementMode(JWEInterface $jwe): string
    {
        $mode = null;
     ...
     */
    private function getCompressionMethod(JWEInterface $jwe): ?CompressionInterface
    {
        $method = null;
     ...
     */
    private function getContentEncryptionAlgorithm(JWEInterface $jwe): ContentEncryptionAlgorithmInterface
    {
        $algorithm = null;
